...
class VADProcessor:
    ...
    def __init__(
        ...
        self._pre_speech_chunks = 5  # ~96ms at 32ms/chunk
    ...
    def _firered_confidence(self, audio_chunk: np.ndarray) -> float:
        ...
        try:
            ...
            for r in frame_results:
                probs.append(float(r.smoothed_prob)) # Return smoothed prob instead of raw prob because Firevad is_speech uses smoothed prob too 
